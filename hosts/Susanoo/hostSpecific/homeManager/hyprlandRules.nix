{...}:
let
  mainMonitor = "monitor:desc:Samsung Electric Company Odyssey G70B H1AK500000";
  sideMonitor = "monitor:desc:Samsung Electric Company U32J59x HTPK701828";
in
{
  desktop.system.workspaceCount = "17";
  wayland.windowManager.hyprland.settings =
  {
    ...
    [
      ...
      "10, ${sideMonitor}, persistent:true, default:true"
      "11, ${sideMonitor}, persistent:true"
      "12, ${sideMonitor}, persistent:true"
      "13, ${sideMonitor}, persistent:true"
      "14, ${sideMonitor}, persistent:true"
      "15, ${sideMonitor}, persistent:true"
